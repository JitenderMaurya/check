...
user_input = "make the formula compact"#"I wan to update"
...
output = generate_user_base_assumption_formula_update_prompt(str(formula), str(assumptions), user_input, user_description)
