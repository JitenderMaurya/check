...
#.....output request..................
total_user = {"2025": 36636612, "2026": 69836969, "2027": 898029279}
revenue = {"2025": 1089208, "2026": 20189208, "2027": 20589805}
total_staff = {"2025": 366366, "2026": 698369, "2027": 8980292}
personel_cost = {"2025": 98292, "2026": 90693, "2027": 91272}
cost = {"2025": 5029208, "2026": 5069308, "2027": 5127208}
ebit = {"2025": -3945204.00, "2026": 15113599.00, "2027": 15455694.00}
ebit_margin = {"2025": -362.21, "2026": 74.86, "2027": 75.06}
net_income = {"2025": -4619478.00, "2026": 12885869.04, "2027": 13384102.16}
net_income_margin = {"2025": -424.11, "2026": 63.83, "2027": 65.00}
total_assets = {"2025": 376222.90, "2026": 11515972.02, "2027": 22565199.40}
current_assets = {"2025": 309136.50, "2026": 10489656.62, "2027": 21523360.15}
current_liabilities = {"2025": 172660.40, "2026": 555863.40, "2027": 565612.34}
account_receivables = {"2025": 32676.24, "2026": 605676.24, "2027": 617694.15}
account_payables = {"2025": 150876.24, "2026": 152079.24, "2027": 153816.24}
inventory = {"2025": 150876.24, "2026": 152079.24, "2027": 153816.24}
equity = {"2025": -4588095.50, "2026": 8366239.62, "2027": 21827586.06}
debt = {"2025": 4705658.00, "2026": 2464869.00, "2027": 1.00}
operating_cashflow = {"2025": -4038554.14, "2026": 12284078.12, "2027": 13681120.62}
investing_cashflow = {"2025": -17830.0, "2026": -10530.0, "2027": -2397.0}
financing_cashflow = {"2025": 4081384.0, "2026": -2668033.0, "2027": -2659933}
debt_issuance = {"2025": 6742739, "2026": 0, "2027": 0}
net_interest_expense = {"2025": -674274.00, "2026": -470566.00, "2027": -246487.00}
interval = "yearly"
analysis_time_frame = ["2025", "2026", "2027"]
weighted_average_cost_of_capital = 12
ebit_multiplier = 8
required_financial_metrics = [
    "Net Present Value of Free Cashflow",
    "Net Present Value of Full Cashflow",
    "IRR of Free Cashflow",
    "Equity IRR (EIRR)",
    "Total New Debt Requirement",
]
required_corporate_kpi = [
    "EBIT",
    "EBIT Margin",
    "Net Income",
    "Net Income Margin",
    "Total Staff",
    "Labour cost as a share of cost",
...
description_payload = {
    ...
    "required_corporate_kpi":required_corporate_kpi,
}

depriciation_key = requests.post(
    f"{BASE_URL}/get_output",
    json=description_payload,
    proxies=proxies
)

print("\nResponse from /get_output")
print(depriciation_key.text)